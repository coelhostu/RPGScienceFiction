...
const CharacterSheet = () => {
  ...
  const updateLasers = (value) => {
    ...
    setFeelingsValue(10 - value); // Feelings é sempre o complemento de Lasers
  };

  return (
    <div className="w-full max-w-4xl mx-auto p-4 font-mono text-sm">
      {/* Cabeçalho - mantido igual */}
      <div className="grid grid-cols-3 gap-1 border-2 border-black">
        <div className="border-r-2 border-black p-2">
          ...
          <div>
            ...
            <textarea className="w-full h-20 p-1 border border-gray-300 rounded" 
              placeholder="O que move seu personagem? Quais seus objetivos?" />
          </div>
        </div>
        ...
        <div className="p-2 text-center">
          <div className="text-2xl font-bold mb-2">S.F.S.</div>
      ...
      <div className="grid grid-cols-2 gap-1 border-2 border-t-0 border-black">
        ...
        <div className="p-2">
          <label className="font-bold block text-center">OCUPAÇÃO ATUAL</label>
